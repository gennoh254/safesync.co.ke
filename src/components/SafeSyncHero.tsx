...
const workflows = {
  ...
  responder: [
    ...
    { id: 2, title: 'Track', icon: MapPin, screenshot: '/assets/responder2.png' },
    { id: 3, title: 'Resolve', icon: CheckCircle, screenshot: '/assets/responder3.png' },
  ]
};
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-10">
            <div className="flex gap-4">
              ...
              <a href="#" className="flex items-center gap-3 px-4 h-12 bg-black text-white rounded-xl border border-white/20 hover:scale-105 transition-transform">
                  <img src="https://res.cloudinary.com/di15s67o/image/upload/f_auto,q_auto/playstore_ae7fqk" alt="Google Play" className="w-8 h-8" />
                  <div className="text-xs">
